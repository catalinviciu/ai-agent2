                ...
                <div className="flex-1 bg-gray-50/50 overflow-hidden relative">
                    {step === 'preview' ? (
                        <div className="h-full flex flex-col items-center p-2 md:p-4 gap-4 animate-in slide-in-from-bottom-4 duration-700 overflow-hidden">
                            ...
                            <div className="w-full max-w-5xl bg-white rounded-xl shadow-sm border border-gray-200 px-3 py-2 flex flex-col md:flex-row items-center justify-start shrink-0 z-20 gap-2 md:gap-4">
                                <span className="font-bold text-gray-900 text-xs text-center md:text-left">
                                    Choose the layout of the driver’s inspection form:
                                </span>

                                <div className="bg-gray-100 p-0.5 rounded-lg flex items-center gap-0.5 shrink-0">
                                    <button
                                        onClick={() => setLayoutMode('defects')}
                                        className={`px-3 py-1 rounded-md transition-all flex flex-col items-center gap-0.5 ${layoutMode === 'defects'
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-md transition-all flex flex-col items-center gap-0.5 ${layoutMode === 'all'
                                            ? 'bg-white text-gray-900 shadow-sm ring-1 ring-black/5'
                                            : 'text-gray-500 hover:text-gray-900 hover:bg-gray-200/50'
                                            }`}
                                    >
                            ...
                            <div className="flex-1 w-full max-w-5xl flex flex-col lg:flex-row gap-4 lg:gap-6 min-h-0">
                                ...
                                <div className="w-full lg:w-80 flex flex-col shrink-0 pt-0">
                                    <div className="bg-white p-3 md:p-4 lg:p-6 rounded-2xl border border-gray-100 shadow-lg space-y-0 lg:space-y-6 relative overflow-hidden">
                                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-400 to-pink-600"></div>

                                        {/* --- MOBILE & TABLET LAYOUT (< lg) --- */}
                                        <div className="lg:hidden flex gap-3">
                                            {/* Left Column: Title/Feedback + Stats/Edit */}
                                            <div className="flex-1 flex flex-col justify-between gap-2 py-0.5">
                                                {/* Top: Title + Feedback */}
                                                <div className="flex items-center justify-between gap-2">
                                                    <h3 className="font-bold text-gray-900 text-sm sm:text-base">Review Form</h3>
                                                    <div className="flex gap-1.5">
                                                        <button className="p-1.5 rounded-lg border border-gray-200 hover:border-red-200 hover:bg-red-50 text-gray-400 hover:text-red-600 transition-all flex items-center justify-center group">
                                                            <ThumbsDown className="w-3.5 h-3.5 group-hover:scale-110 transition-transform" />
                                                        </button>
                                                        <button className="p-1.5 rounded-lg border border-gray-200 hover:border-green-200 hover:bg-green-50 text-gray-400 hover:text-green-600 transition-all flex items-center justify-center group">
                                                ...
                                                <div className="flex items-center justify-between gap-2">
                                                    <div className="flex items-center gap-3 text-[10px] sm:text-xs text-gray-500">
                                                        <span>Items <span className="font-bold text-gray-900">70</span></span>
                                                        <span>Groups <span className="font-bold text-gray-900">10</span></span>
                                                    </div>
                                                    <button className="py-1.5 px-3 rounded-lg border border-gray-200 hover:border-orange-200 hover:bg-orange-50 text-gray-700 font-bold text-[10px] sm:text-xs transition-all flex items-center gap-2 whitespace-nowrap">
                                                        <span>Edit Manually</span>
                                                    </button>
                                                </div>
                                            </div>

                                            {/* Right Column: Tall Publish Button */}
                                            <button
                                                onClick={handlePublish}
                                                className="w-24 sm:w-32 bg-gray-900 hover:bg-black text-white rounded-xl font-bold text-xs shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-2 shrink-0"
                                            >
                                        ...
                                        <div className="hidden lg:block space-y-6">
                                            <div>
                                                <h3 className="font-bold text-gray-900 text-xl mb-1">Review Form</h3>
                                            ...
                                            {/* Feedback */}
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Feedback</label>
                                                <div className="flex gap-3">
                                                    <button className="flex-1 py-3 px-3 rounded-xl border border-gray-200 hover:border-red-200 hover:bg-red-50 text-gray-400 hover:text-red-600 transition-all flex flex-col items-center gap-1 group">
                                                    ...
                                                    <button className="flex-1 py-3 px-3 rounded-xl border border-gray-200 hover:border-green-200 hover:bg-green-50 text-gray-400 hover:text-green-600 transition-all flex flex-col items-center gap-1 group">
                                            ...
                                            <div className="space-y-3">
                                                <button className="w-full py-3 px-4 rounded-xl border border-gray-200 hover:border-orange-200 hover:bg-orange-50 text-gray-700 font-bold text-sm transition-all flex items-center justify-between group">
                                                    <span>Edit Manually</span>
                                                ...
                                                <button
                                                    onClick={handlePublish}
                                                    className="w-full py-3 px-4 bg-gray-900 hover:bg-black text-white rounded-xl font-bold text-sm shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-between group"
                                                >
                                                    <span>Publish Form</span>
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center p-8 animate-in zoom-in duration-500">
                            ...
                            <p className="text-gray-500 max-w-md mx-auto mb-8 text-lg">
                                Your inspection form has been published. Next step is to try it out on your own device.
                            </p>
                            <button
                                onClick={onClose}
